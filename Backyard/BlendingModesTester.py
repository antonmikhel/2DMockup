...
img_1 = cv2.imread(r"D:\Dev\Resources\Products\TanktopWhite.jpg",
                   cv2.CV_LOAD_IMAGE_UNCHANGED).astype(numpy.float)
img_1_mask = cv2.imread(r"D:\Dev\Resources\Products\TanktopWhite_Mask.jpg",
                        cv2.CV_LOAD_IMAGE_UNCHANGED).astype(numpy.float)
...
blended = blend_modes.multiply(img_1_logo, img_1_mask, 1.0)
...
cv2.imwrite(r"D:\Dev\Resources\Tests\horse_shirt.jpg", blended.astype(numpy.uint8))
